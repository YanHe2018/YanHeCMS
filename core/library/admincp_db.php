	...
	if(!submitcheck('exportsubmit')) {
		...
		if($_GET['method'] == 'multivol') {
			...
			if(trim($sqldump)) {
				$sqldump = "$idstring".
					"# <?php exit();?>\n".
					"# YHCMS! Multi-Volume Data Dump Vol.$volume\n".
					"# Version: YHCMS! {$_G['setting']['version']}\n".
					"# Time: $time\n".
					"# Type: {$_GET['type']}\n".
					"# Table Prefix: $tablepre\n".
					"#\n".
					"# YHCMS! Home: https://www.discuz.vip\n".
					"# Please visit our website for newest infomation about YHCMS!\n".
					"# --------------------------------------------------------\n\n\n".
					"$setnames".
					$sqldump;
