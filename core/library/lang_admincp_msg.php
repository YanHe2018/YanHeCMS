...
$lang = array (
  ...
  'dzcode_edit_succeed' => 'YHCMS! 代码更新成功 ',
  ...
  'cloudaddons_noaccess' => '只有网站创始人账号才能使用 <a href="https://addon.dismall.com/" target="_blank">YHCMS! 应用中心</a> 安装插件和模板，如有疑问，请进入应用中心咨询应用中心客服：<a href="https://addon.dismall.com/" target="_blank">https://addon.dismall.com/</a>',
  ...
  'database_run_query_succeed' => 'YHCMS! 数据结构升级成功，影响的记录行数 {affected_rows}',
  ...
  'plugins_import_version_invalid_confirm' => '本插件适用于 YHCMS! {cur_version} 与当前版本({set_version})不一致，您确定要安装吗？<br />如果本插件的安装说明中不包含修改文件的内容则说明此插件为绿色插件，您可放心安装',
  'plugins_import_version_invalid' => '本插件适用于 YHCMS! {cur_version} 与当前版本({set_version})不一致',
  ...
  'upgrade_successful' => '恭喜您，升级成功! <br />您当前的版本为：[YHCMS! X{version} Release[{release}] <br /><br />为安全起见，升级文件已保存至{save_update_dir}目录，<br />备份文件已保存至{save_back_dir}目录 {upgradeurl}',
