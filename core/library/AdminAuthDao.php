 ...
 * 用户权限角色表
 *
 * @author YanHe 2011-11-12
 * @copyright ©2003-2103 YHCMS
 * @license YHCMS
 * @version $Id: AdminAuthDao.php 14190 2012-07-18 03:26:14Z xiaoxia.xuxx $
 * @package admin
 * @subpackage service.dao
 */
class AdminAuthDao extends PwBaseDao {
	protected $_table = 'admin_auth';
	protected $_dataStruct = array('id', 'uid', 'username', 'roles', 'created_time', 'modified_time');
